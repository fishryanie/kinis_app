...
export const HomeScreen: React.FC<HomeScreenProps> = props => {
  ...
  const startScanning = () => {
    bleManager.startDeviceScan(null, null, (error, scannedDevice) => {
      console.log('🚀 ~ bleManager.startDeviceScan ~ scannedDevice:', scannedDevice);
      if (error) {
  ...
  return (
    <View flex safePaddingBottom safePaddingTop safeMarginTop safeMarginBottom>
      <Button onPress={startScanning} title="HomeScreen" />
      <FlatList data={devices} keyExtractor={item => item.id} renderItem={renderItem} contentContainerStyle={styles.list} />
      {connectedDevice && (
